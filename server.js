...
app.get('/' , (req , res ) => { 
     res.send("allowed endpoints [ /jokes , /jokes/ten , /jokes/:number , /jokes/random/:dialect , /jokes/random/:dialect/:number ] ") 
 });
